...
const loan = {
    ...
    getAllLoansCountOfUser: (signal?: AbortSignal) => methods.get("loan/account/count", {}, signal),
...
const userReview = {
    ...
    getAllUserReviewsCountOfUser: (signal?: AbortSignal) => methods.get("userreview/account/count", {}, signal),
