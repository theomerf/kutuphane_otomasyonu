    ...
    useEffect(() => {
        ...
        const loadTags = async () => {
            try {
                ...
                const tags = await fetchTags(finalQuery);
                setData(tags);
            }
            catch (error: any) {
    ...
    return (
        <div className="flex flex-col">
            <div className="flex flex- row">
                <p className="font-semibold text-4xl ml-8 lg:ml-20 text-violet-500 h-fit border-none pb-2 mb-12 relative after:content-[''] after:absolute after:bottom-[-10px] after:left-0 after:w-20 after:h-1 after:bg-hero-gradient after:rounded-sm">Etiket Yönetimi</p>
                ...
                <Link to="/admin/tags/create" className="button !bg-green-400 hover:scale-105 text-lg font-bold duration-500 self-center ml-auto mr-20">
                            ...
                            <table className="table-auto w-full border-collapse border border-gray-200 bg-white shadow-lg">
                                <thead>
                                    <tr className="bg-violet-400">
                                        ...
                                        <th className="text-white font-bold text-lg border border-gray-200 px-4 py-6 text-center">Ana Etiket</th>
