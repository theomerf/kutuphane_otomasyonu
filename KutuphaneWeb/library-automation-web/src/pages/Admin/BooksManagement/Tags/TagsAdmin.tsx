        ...
        <div className="flex flex-col">
            <div className="flex flex-col md:flex-row mx-4 md:mx-8 lg:mx-20 gap-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2 md:gap-4 md:ml-auto">
                    <Link to="/admin/tags/create" className="lg:self-center button !bg-green-400 hover:scale-105 text-sm md:text-lg font-bold duration-500 text-center py-2">
                        <FontAwesomeIcon icon={faPlus} className="mr-2" />
                        {isMobile ? "Ekle" : "Yeni Etiket Ekle"}
                    </Link>
                        ...
                        <>
                            {isMobile ? (
                                <div className="space-y-4">
                                    {tags.data.map((tag) => (
                                        <div key={tag.id} className="bg-white rounded-lg shadow-md p-4 border border-gray-200">
