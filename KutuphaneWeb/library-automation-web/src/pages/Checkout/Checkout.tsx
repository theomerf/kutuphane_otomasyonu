...
export default function Checkout() {
    ...
    return (
        <div className="flex flex-col">
            <p className="font-semibold text-4xl ml-8 lg:ml-20 text-violet-500 h-fit border-none pb-2 mb-8 relative after:content-[''] after:absolute after:bottom-[-10px] after:left-0 after:w-20 after:h-1 after:bg-hero-gradient after:rounded-sm">Kiralamayı Tamamla</p>
            <div className="grid grid-cols-2 gap-x-20 px-8 lg:px-28">
                <div className="flex flex-col">
                    <div className="px-8 py-6 bg-violet-500 rounded-tl-lg rounded-tr-lg">
                    ...
                    <div className="flex flex-col gap-y-6 rounded-lg shadow-xl bg-white border border-gray-200 px-8 py-10">
                        ...
                        <div className="flex flex-row mt-10 gap-x-4">
                            <button onClick={() => handleLoanCreation()} className="button w-1/2 font-bold text-lg !py-4 hover:scale-105 duration-300">
                ...
                <div className="flex flex-col ">
                    ...
                    <div className="flex flex-col gap-y-6 rounded-lg shadow-xl bg-white border h-full border-gray-200 px-8 py-10">
                        <div className="flex flex-col rounded-xl border-gray border-2 gap-y-2 shadow-lg px-4 py-6">
                            <div className="flex flex-row">
                                <p className="font-semibold text-base text-gray-600">Toplam kiralama günü:</p>
                                <p className="font-semibold text-gray-500 ml-auto"> 30 gün</p>
                            </div>
                            <div className="flex flex-row">
                                <p className="font-semibold text-base text-gray-600">Kiralanan toplam kitap:</p>
                                <p className="font-semibold text-gray-500 ml-auto">{computeTotalBooks().toString()}</p>
                            </div>
                            <div className="flex flex-row">
                                <p className="font-semibold text-base text-gray-600">İşlem bedeli:</p>
                                <p className="font-semibold text-gray-500 ml-auto">{computeTotalBooks() * 30} ₺</p>
                            </div>
                        </div>
                        <div className="flex flex-col rounded-xl border-gray border-2 gap-y-2 shadow-lg px-4 py-6">
                            <div className="flex flex-row">
                                <p className="font-semibold text-base text-gray-600">Kiralama başlangıç günü:</p>
                                <p className="font-semibold text-gray-500 ml-auto">{computeStartDate().toLocaleDateString()}</p>
                            </div>
                            <div className="flex flex-row">
                                <p className="font-semibold text-base text-gray-600">Kiralama bitiş günü:</p>
                                <p className="font-semibold text-gray-500 ml-auto">{computeEndDate().toLocaleDateString()}</p>
                            </div>
                            <div className="flex flex-row">
                                <p className="font-semibold text-base text-gray-600">Gecikme haftası / ceza:</p>
                                <p className="font-semibold text-gray-500 ml-auto">{computeTotalBooks() * 50} ₺</p>
                            </div>
                        </div>
                        <div className="text-sm text-gray-500 flex flex-col mt-auto ">
